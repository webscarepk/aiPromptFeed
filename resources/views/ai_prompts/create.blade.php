...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
            <form action="{{ isset($aiPrompt) ? route('ai-prompts.update', $aiPrompt) : route('ai-prompts.store') }}"
                ...
                <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2">
                                <select name="category_id" id="category_id"
                                    class="flex-1 bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 transition"
                                    required>
                    ...
                    <div>
                        ...
                        <textarea name="prompt" id="prompt" rows="4"
                            class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-blue-500 transition placeholder-gray-600"
                            placeholder="Describe the prompt in detail..."
                            required>{{ old('prompt', $aiPrompt->prompt ?? '') }}</textarea>
                    </div>

                    <!-- Description -->
                    <div>
                        <label for="description" class="block text-sm font-medium text-gray-300 mb-2">Description
                            (Optional)</label>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-8">
                            ...
                            <div class="flex-grow">
                                <label
                                    class="w-full flex flex-col items-center px-4 py-6 bg-gray-900 text-blue-400 rounded-lg border-2 border-dashed border-gray-700 cursor-pointer hover:border-blue-500 transition">
                ...
                <div class="p-8 bg-gray-900/50 border-t border-gray-700 flex justify-end">
                    <button type="submit"
                        class="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-lg shadow-lg transform transition active:scale-95">
